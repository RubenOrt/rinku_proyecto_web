		...
		<div class="container">
			...
			<div id="navbar" class="collapse navbar-collapse">
				<ul class="nav navbar-nav">
					<li><a href="./View/vista_empleados.php">Empleados</a></li>
					<li><a href="./View/vista_movimientos.php">Movimientos</a></li>
					<li><a href="/View/vista_reporte.php">Reporte de Nomina</a></li>
