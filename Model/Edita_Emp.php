<?php
/*Modelo creado para la modificacion de los datos nuevos del empleado, validando cada dato importante para no ocasionar algun
		...
		if(isset($_POST['nombre']))
		 {
			 ...
			 if(isset($_POST['Rol']))
			 {
				 if($_POST['Rol'] <> '0')
				 {
					...
					$ctrl_emp->Edita_Emp($Numero,$Nombre_Completo,$Rol);
